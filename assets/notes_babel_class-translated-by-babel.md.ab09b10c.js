...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h2 id="es5-code" tabindex="-1">ES5 code <a class="header-anchor" href="#es5-code" aria-label="Permalink to &quot;ES5 code&quot;">​</a></h2><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-oYn0a" id="tab-CAEEs-z" checked="checked"><label for="tab-CAEEs-z">Class</label><input type="radio" name="group-oYn0a" id="tab-xpfFeKp"><label for="tab-xpfFeKp">_classCallCheck &amp; _defineProperty</label><input type="radio" name="group-oYn0a" id="tab-jqclhsl"><label for="tab-jqclhsl">_classApplyDescriptorGet &amp; _classApplyDescriptorSet</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">var</span><span style="color:#E1E4E8;"> _ba </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;">/*#__PURE__*/</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">new</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">WeakMap</span><span style="color:#E1E4E8;">()</span></span>
<span class="line"></span>
