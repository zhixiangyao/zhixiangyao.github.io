import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.af5d88b3.js";const C=JSON.parse('{"title":"分析 react-loadable","description":"","frontmatter":{},"headers":[],"relativePath":"notes/react/analyze-react-loadable.md","filePath":"notes/react/analyze-react-loadable.md","lastUpdated":1670211367000}'),p={name:"notes/react/analyze-react-loadable.md"},o=l(`<h1 id="分析-react-loadable" tabindex="-1">分析 <code>react-loadable</code> <a class="header-anchor" href="#分析-react-loadable" aria-label="Permalink to &quot;分析 \`react-loadable\`&quot;">​</a></h1><p>最近在学习 <code>react</code> 的路由配置，想到 <code>vue</code> 里的按需加载</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// vue router.ts</span></span>
